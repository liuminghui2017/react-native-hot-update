...
public class FileUtils {
        ...
        for (File sourceFile : sourceDir.listFiles()) {
            if (sourceFile.isDirectory()) {
                copyDirectoryContents(
                        HotUpdateUtils.appendPathComponent(sourceDirectoryPath, sourceFile.getName()),
                        HotUpdateUtils.appendPathComponent(destinationDirectoryPath, sourceFile.getName()));
            } else {
    ...
    public static void deleteDirectoryAtPath(String directoryPath) {
        if (directoryPath == null) {
            HotUpdateUtils.log("deleteDirectoryAtPath attempted with null directoryPath");
            return;
        }
    ...
    public static void deleteFileOrFolderSilently(File file) {
        ...
        if (!file.delete()) {
            HotUpdateUtils.log("Error deleting file " + file.getName());
        }
    }
    ...
    public static void moveFile(File fileToMove, String newFolderPath, String newFileName) {
        ...
        if (!fileToMove.renameTo(newFilePath)) {
            throw new HotUpdateUnknownException("Unable to move file from " +
